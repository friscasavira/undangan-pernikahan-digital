                    ...
                    <div class="row g-4 align-items-center">
                        <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="d-flex">
                                ...
                                <img src="{{ asset('storage/' . $wedding->bride_photo) }}" class="img-fluid w-100 img-border" alt=""  style="height: 100px; object-fit: cover;">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="d-flex">
                                <img src="{{ asset('storage/' . $wedding->groom_photo) }}" class="img-fluid w-100 img-border" alt=""  style="height: 100px; object-fit: cover;">
