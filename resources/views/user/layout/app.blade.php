<html>
  ...
  <body class="font-montserrat w-full h-auto min-h-screen flex flex-col">
    <!-- Main Section -->
    <section class="w-full h-screen flex flex-col items-center justify-center text-white bg-fixed bg-cover bg-no-repeat bg-center" style="background-image: url({{ asset('images/main_image') }});">
