...
class WeddingController
{
    ...
    {
        $events = events::where('id_wedding', $id)->get();
        $love_storys = love_story::where('id_wedding', $id)->get();
        $photos = photos::where('id_wedding', $id)->get();
        return view('backend.admin.detail', compact('events', 'love_storys', 'photos'));
    }
    ...
    public function detailUser($id)
    {
        ...
        $love_storys = love_story::where('id_wedding', $id)->get();
        $photos = photos::where('id_wedding', $id)->get();
        return view('backend.user.detail', compact('id', 'events', 'love_storys', 'photos'));
    }
    ...
    public function storeUser(Request $request)
    {
        ...
        $request->validate([
            ...
            'location' => 'required',
            'message' => 'required',
            'bride_photo' => 'required|image|mimes:jpeg,jpg,png,gif|max:2048',
            'groom_photo' => 'required|image|mimes:jpeg,jpg,png,gif|max:2048',
        ]);
